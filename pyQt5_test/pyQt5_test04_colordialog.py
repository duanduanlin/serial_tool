...
# -*- coding:utf-8 -*-
'''
Creat a simple filedialog
'''
__author__ = 'Duanlin D'

from PyQt5.QtWidgets import QApplication, QDialog, QColorDialog, QPushButton, QGridLayout, QFrame
...
class ColorDialog(QDialog):
    ...
    def openColor(self):
        color = QColorDialog.getColor(Qt.white, None, "Selecting Color")
        if color.isValid():
