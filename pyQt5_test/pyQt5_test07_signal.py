...
# -*- coding:utf-8 -*-
'''
Creat a simple signal example

---------------------
作者：追逐阳光的风
来源：CSDN
原文：https://blog.csdn.net/zhulove86/article/details/52530214
'''
__author__ = 'Duanlin D'

import sys
from PyQt5.QtCore import Qt
from PyQt5.QtWidgets import (QWidget, QLCDNumber, QSlider,QGridLayout,QLabel,QHBoxLayout,
                             QGroupBox, QVBoxLayout, QApplication,QProgressBar,QPushButton,QMessageBox)
